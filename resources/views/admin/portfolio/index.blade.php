        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="{{ route('portfolio.create') }}" class="btn btn-primary btn-md">Create
                        {{ $title }}</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($portfolios as $portfolio)
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset($portfolio->image) }}" alt="{{ $portfolio->title }}"
                                                width="100" height="50"></td>
                                        <td>{{ $portfolio->meta_description }}</td>
                                        <td>{{ str_replace(',', ' ', $portfolio->skills()) }}</td>
